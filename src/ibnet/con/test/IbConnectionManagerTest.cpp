...
{
public:
    ClientThread(uint32_t id, con::NodeId ownNodeID,
...
int main(int argc, char** argv)
{
    ...
    std::shared_ptr<ibnet::core::IbCompQueue> compQueue2 =
        std::make_shared<ibnet::core::IbCompQueue>(device, 100);
    ...
    uint16_t ownNodeId = ibnet::core::IbNODE_ID_INVALID;
    ...
    if (ownNodeId == ibnet::core::IbNODE_ID_INVALID) {
    ...
    std::shared_ptr<ibnet::core::IbConnectionManager> conMan =
        ...
        std::make_unique<ibnet::core::IbConnectionCreatorSimple>(ownNodeId, 10,
            10, compQueue2, nullptr, compQueue));
