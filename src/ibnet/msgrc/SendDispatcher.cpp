...
SendDispatcher::SendDispatcher(uint32_t recvBufferSize,
    ...
    m_nonEmptyNextWorkPackage(new stats::Unit("SendDispatcher", "SendNonEmptyNextWorkPackage")),
    m_sendDataFullBuffers(new stats::Unit("SendDispatcher", "SendDataFullBuffers")),
    m_sendDataNonFullBuffers(new stats::Unit("SendDispatcher", "SendDataNonFullBuffers")),
    m_sendBatches(new stats::Unit("SendDispatcher", "SendBatches")),
    m_emptyCompletionPolls(new stats::Unit("SendDispatcher", "SendEmptyCompletionPolls")),
    m_nonEmptyCompletionPolls(new stats::Unit("SendDispatcher", "SendNonEmptyCompletionPolls")),
    m_completionBatches(new stats::Unit("SendDispatcher", "SendCompletionBatches")),
    m_nextWorkPackageRatio(new stats::Ratio("SendDispatcher", "SendNextWorkPackageRatio",
        m_nonEmptyNextWorkPackage, m_emptyNextWorkPackage)),
    m_sendDataFullBuffersRatio(new stats::Ratio("SendDispatcher", "SendDataFullBuffersRatio",
        m_nonEmptyNextWorkPackage, m_emptyNextWorkPackage)),
    m_emptyCompletionPollsRatio(new stats::Ratio("SendDispatcher", "SendEmptyCompletionPollsRatio",
        m_nonEmptyCompletionPolls, m_emptyCompletionPolls)),
    m_throughputSentData(new stats::Throughput("SendDispatcher", "SentThroughputData", m_sentData,
        m_totalTime)),
    m_throughputSentFC(new stats::Throughput("SendDispatcher", "SentThroughputFC", m_sentFC,
        m_totalTime)),
